...
bash "$SCRIPT_DIR/05-agent-builder-lab-agents.sh"
bash "$SCRIPT_DIR/06-kibana-workflows-lab.sh"
bash "$SCRIPT_DIR/07-lab-alert-rules.sh"
bash "$SCRIPT_DIR/09-lab-dashboards-api.sh"
bash "$SCRIPT_DIR/11-index-sourcecode.sh"
