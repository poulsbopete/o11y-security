...
| Path | What it is |
| ---- | ----------- |
| [`elastic-agent-builder-a2a-workshop/`](elastic-agent-builder-a2a-workshop/) | **Instruqt** track (`elastic-a2a-serverless-agent-builder`): `track.yml`, `config.yml`, dual **Serverless** Kibana tabs via one **workstation** nginx proxy (ports 8080/8081), **Chaos Console** (8082), challenges (`01-`…`07-`), `lab-app/` (planted code issues), index templates, sample NDJSON/JSON, lifecycle scripts, agent scaffolds. **How to run:** [`elastic-agent-builder-a2a-workshop/README.md`](elastic-agent-builder-a2a-workshop/README.md). |
